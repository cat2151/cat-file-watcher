...
class TestTimePeriodChecker:
    ...
    def test_get_time_period_config_invalid(self):
        ...
        config = {
            "time_periods": {
                "valid": {"start": "09:00", "end": "17:00"},
                "missing_end": {"start": "09:00"},
                "invalid_time": {"start": "25:00", "end": "17:00"},
            }
        }
    ...
    def test_should_monitor_file_with_valid_period(self):
        ...
        config = {"time_periods": {"test_period": {"start": "00:00", "end": "23:59"}}}
        settings = {"command": "echo test", "time_period": "test_period"}
    ...
    def test_should_monitor_file_with_invalid_period(self):
        ...
        config = {"time_periods": {"valid": {"start": "09:00", "end": "17:00"}}}
        settings = {
            "command": "echo test",
