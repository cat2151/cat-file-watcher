...
'''
        ...
        with pytest.raises(Exception):  # subprocess.TimeoutExpired
            CommandExecutor.execute_command("sleep 60", self.test_file, {"command": "sleep 60"}, watcher.config)
...
'''
        ...
        CommandExecutor.execute_command("exit 1", self.test_file, {"command": "exit 1"}, watcher.config)
...
'''
        ...
        CommandExecutor.execute_command(
            "echo test", self.test_file, {"command": "echo test", "enable_log": True}, watcher.config
        )
